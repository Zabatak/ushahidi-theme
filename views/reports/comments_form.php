...
<div class="alert alert-block alert-error">
  ...
  <strong><?php echo Kohana::lang('ui_main.error');?></strong>
			<ul>
				<?php
	...
	?>
	<div class="report_row">
		<input name="submit" type="submit" value="<?php echo Kohana::lang('ui_main.reports_btn_submit'); ?> <?php echo Kohana::lang('ui_main.comment'); ?>" class= "btn" ></input>
	</div>
