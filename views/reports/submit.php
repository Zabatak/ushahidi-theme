		...
		<div>
			...
			<div class="row">
				...
				<div class="span6">
					...
					<div class="report_row">
						...
						<div class="report-find-location">
							...
							<div style="float:left;margin:9px 0 0 5px;">
								<input type="button" name="button" id="button" value="<?php echo Kohana::lang('ui_main.find_location'); ?>" class="btn_find  btn btn-inverse" />
							</div>
					...
					<div class="report_row">
						<input name="submit" style="width:100%" type="submit" value="<?php echo Kohana::lang('ui_main.reports_btn_submit'); ?>" class=" btn btn-primary btn-large " /> 
					</div>
				</div>
			</div>
		</div>
