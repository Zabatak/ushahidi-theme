<div id="" class="report_detail row">

	<div class="span7">

  	  <?php if ($incident_verified): ?>
    		    <span class="label label-success pull-right"> <?php echo Kohana::lang('ui_main.verified') ?> </span>
    		<?php else: ?>
    			<span class=" label label-important pull-right"> <?php echo Kohana::lang('ui_main.unverified') ?></span>
    		<?php endif ?>
		...
		<div class="report-description-text">
          ...
          <tr>
            ...
            <td><a href="javascript:rating('<?php echo $incident_id; ?>','add','original','oloader_<?php echo $incident_id; ?>')"><i id="oup_<?php echo $incident_id; ?>" class="icon-thumbs-up" alt="UP" title="UP" /></a></td>
            <td><a href="javascript:rating('<?php echo $incident_id; ?>','subtract','original')"><i id="odown_<?php echo $incident_id; ?>" class="icon-thumbs-down" alt="DOWN" title="DOWN" border="0" /></a></td>
            <td><span href="" class="rating_value label" id="orating_<?php echo $incident_id; ?>"><?php echo $incident_rating; ?></span></td>
